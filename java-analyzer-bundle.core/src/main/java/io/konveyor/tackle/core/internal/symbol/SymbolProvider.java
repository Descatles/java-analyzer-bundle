...
public interface SymbolProvider {
     ...
     */
    default boolean queryQualificationMatchesForConstructor(String query, ICompilationUnit unit, Location location) {
        // Remove any parentheses and their contents
        String className = query.replaceAll("\\(.*\\)", "");
        className = className.replaceAll("(?<!\\.)\\*", ".*");
        
        // For constructors, the entire className is the qualification
        return queryQualificationMatches(query, className, unit, location);
    }
     ...
     */
    default boolean queryQualificationMatchesForMethod(String query, ICompilationUnit unit, Location location) {
        // Remove any parentheses and their contents
        ...
        return queryQualificationMatches(query, queryQualification, unit, location);
    }
     ...
     */
    default boolean queryQualificationMatches(String query, String queryQualification, ICompilationUnit unit, Location location) {
